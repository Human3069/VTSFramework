...
{
    [ExecuteInEditMode]
    public class TS_ClampedRotaryKnobEx : TS_BaseKnobEx
    {
        ...
        [Space(10)]
        public UnityEvent<float> OnKnobGrabbedEvent = default;
        public UnityEvent<float> OnValueChangedEvent = default;
        public UnityEvent<float> OnKnobReleasedEvent = default;
        ...
        public override async UniTask WaitUntilCorrectInteract(string _targetValue)
        {
            ...
            bool PredicateFunc()
            {
                return Normalized == targetValue && _isGrabbed == false;
            }
        }
        ...
        public override void OnGrabbed()
        {
            ...
            OnKnobGrabbedEvent.Invoke(Normalized);
        ...
        protected override void OnValueChanged()
        {
            ...
            if (Application.isPlaying == true)
            {
                OnValueChangedEvent.Invoke(Normalized);
            }
        }
        ...
        public override void OnReleased()
        {
            ...
            OnKnobReleasedEvent.Invoke(Normalized);
        }
