...
{
    public class _3DDelayButton : _3DInteractable
    {
    ...
    public class _3DDelayButtonEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (delayType.GetValue<_3DDelayButton.DelayType>() == _3DDelayButton.DelayType.Fixed)
            {
                EditorGUILayout.PropertyField(onObjs);
            }

            if (delayType.GetValue<_3DDelayButton.DelayType>() == _3DDelayButton.DelayType.Continuous)
            {
