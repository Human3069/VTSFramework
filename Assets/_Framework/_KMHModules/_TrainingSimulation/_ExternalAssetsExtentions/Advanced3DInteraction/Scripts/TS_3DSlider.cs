...
{
    public class TS_3DSlider : MonoBehaviour
    {
        // private const string LOG_FORMAT = "<color=white><b>[TS_3DSlider]</b></color> {0}";

        [SerializeField]
        protected TS_3DSliderHandle handle;
        ...
        {
            ProgressValue = float.Parse(order);
